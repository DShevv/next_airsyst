    ...
    <main>
      ...
      <section className="catalog wrap">
        ...
        <p>
          ...
          компрессоров начитнается с 4 кВт и заканчивается 315 кВт. Мы
          предлагаем оценить наши цены и качесвто. Гарантия на оборудование до
          10 лет, при&nbsp; условии заключения сервисного догвора.
        </p>
